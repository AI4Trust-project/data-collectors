kubectl delete -f unifier/unifier.yaml
kubectl delete -f hate_speech_detector/hate_speech_detector.yaml
kubectl delete -f dynamicrouting/dynamicrouter.yaml

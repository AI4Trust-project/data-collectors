...
def handler(context, event):
    video_id = json.loads(event.body.decode("utf-8"))
    ...
    try:
        ...
        # Open the JSON file.
        json_file = open("meta.json", "rb")

        # Upload the JSON file to Minio in a streaming fashion.
        object_name = "{}/{}".format(generate_folder(video_id), "meta.json")
        context.client.fput_object(
            "videos", object_name, json_file, content_type="application/json"
        )
